...
public class ControllerMessage implements ActionListener {
     ...
     private DataValidation_1 dataValidation = new DataValidation_1();

    public ControllerMessage(ModelMessage modelMessage, ViewCalculadora viewMessage) {
